...
def get_retriever():
 ...
 # Load your data
 with open(r"documents\essay.txt", "r") as f:
  data = f.read()
...
def get_agent(retriever):
 ...
 search_tool = Tool(
  name="banking_product_search",
  pipeline_or_node=pipeline,
  description="useful for when you need to answer questions about the banking products at Dollarwise Bank",
...
@cl.on_chat_start
async def init():
 question = "What are the loan products offered by Dollarwise Bank?"
 ...
 # question = "Do you have business loans?"
